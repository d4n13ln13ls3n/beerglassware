...
import { SearchBeerProps } from '../types';

const DropDown = ({ beer, setBeer }: SearchBeerProps) => {
  const [query, setQuery] = useState('');

  const filteredBeers =
    query === ''
    ? beerStyles
    : beerStyles.filter((item) =>
      item
        .toLowerCase()
        .replace(/\s+/g, '')
  ...
  return (
    <div className='search-manufacturer'>
      <Combobox value={beer} onChange={setBeer}>
        <div className='relative w-full'>
          ...
          <Combobox.Input
            ...
            placeholder='Type and select beer style...'
          />
          <Transition
            as={Fragment}
